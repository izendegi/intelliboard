...
$PAGE->set_url(new moodle_url("/local/intelliboard/pf/transcript.php", array("userid" => $userid, "search" => $search)));
...
$profile = intelliboard_pf_user($userid);

$table = new intelliboard_pf_transcript_table('table', $userid, $search);
...
<div class="intelliboard-page intelliboard-pf">
	...
	<?php else: ?>
		<div class="alert alert-info alert-block fade in " role="alert">Please select USER</div>
	<?php endif; ?>
